use crate::{AttrSigInfo, info_extractor::{InputStructType, SerializerType, TraitItemMethodInfo}};
use quote::quote;
...
impl TraitItemMethodInfo {
    ...
    pub fn method_wrapper(&self) -> TokenStream2 {
        ...
        let serialize = TraitItemMethodInfo::generate_serialier(&self.attr_sig_info, &self.attr_sig_info.result_serializer);
        quote! {
