//! Platform-level dispatch for crypto hashing and process abort.
//!
//! Delegates to WASM host functions when targeting `wasm32`, and falls back
//! to native Rust implementations otherwise. Similar to the `env` module in `near-sdk`.
