<div align="center">
  ...
  <p>
      Minimum supported Rust version (MSRV) is <strong>1.95.0</strong>
  </p>


  <p>
    <a href="https://docs.rs/near-sdk"><img src="https://docs.rs/near-sdk/badge.svg?style=flat-square" alt="Reference Documentation" /></a>
    <a href="https://blog.rust-lang.org/2026/04/16/Rust-1.95.0/"><img src="https://img.shields.io/badge/rustc-1.95-lightgray.svg?style=flat-square" alt="MSRV" /></a>
...
The minimum supported Rust version is currently `1.95`. There are no guarantees that this will be upheld if a security patch release needs to come in that requires a Rust toolchain increase.
