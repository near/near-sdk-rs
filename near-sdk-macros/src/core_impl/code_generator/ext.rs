use crate::core_impl::{serializer, AttrSigInfoV1};
...
pub(crate) fn generate_ext_function_wrappers<'a>(
    ident: &Ident,
    methods: impl IntoIterator<Item = &'a AttrSigInfoV1>,
) -> TokenStream2 {
...
fn generate_ext_function(attr_signature_info: &AttrSigInfoV1) -> TokenStream2 {
    ...
    let AttrSigInfoV1 { non_bindgen_attrs, ident, original_sig, .. } = attr_signature_info;
