...
use near_sdk::{contract_error, require, unwrap_or_err, AccountId, BaseError};
...
impl TokensNotFound {
    pub fn new() -> Self {
        Self { message: "Could not find tokens_per_owner when calling a method on the \
        enumeration standard.".to_string() }
    }
}
