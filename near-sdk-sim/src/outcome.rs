...
impl ExecutionResult {
    #[doc(hidden)]
    pub fn new(outcome: ExecutionOutcome, runtime: &Rc<RefCell<RuntimeStandalone>>, hash: CryptoHash) -> Self {
...
mod tests {
    ...
    fn value_test() {
        ...
        let result = outcome_into_result((CryptoHash::default(), outcome), &Rc::new(RefCell::new(init_runtime(None).0)));
