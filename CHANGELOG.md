...
- Fixes NFT contract standard `mint` function to not be in the `NonFungibleTokenCore` and thus no longer externally callable. [PR 525](https://github.com/near/near-sdk-rs/pull/525)
