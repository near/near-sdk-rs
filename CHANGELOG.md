...
- Fixes NFT contract standard `mint` function to not be in the `NonFungibleTokenCore` trait and can no longer be externally called. [PR 525](https://github.com/near/near-sdk-rs/pull/525)
