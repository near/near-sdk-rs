...
mod mock_chain {
    ...
    #[no_mangle]
    extern "C-unwind" fn bls12381_g1_multiexp(value_len: u64, value_ptr: u64, register_id: u64) -> u64 {
        with_mock_interface(|b| b.bls12381_g1_multiexp(value_len, value_ptr, register_id))
    }
    #[no_mangle]
    extern "C-unwind" fn bls12381_g2_multiexp(value_len: u64, value_ptr: u64, register_id: u64) -> u64 {
        with_mock_interface(|b| b.bls12381_g2_multiexp(value_len, value_ptr, register_id))
    }
    #[no_mangle]
    extern "C-unwind" fn bls12381_map_fp_to_g1(value_len: u64, value_ptr: u64, register_id: u64) -> u64 {
        with_mock_interface(|b| b.bls12381_map_fp_to_g1(value_len, value_ptr, register_id))
    }
    #[no_mangle]
    extern "C-unwind" fn bls12381_map_fp2_to_g2(value_len: u64, value_ptr: u64, register_id: u64) -> u64 {
    ...
    #[no_mangle]
    extern "C-unwind" fn bls12381_p1_decompress(value_len: u64, value_ptr: u64, register_id: u64) -> u64 {
        with_mock_interface(|b| b.bls12381_p1_decompress(value_len, value_ptr, register_id))
    }
    #[no_mangle]
    extern "C-unwind" fn bls12381_p2_decompress(value_len: u64, value_ptr: u64, register_id: u64) -> u64 {
