...
use crate::{testing_env, AccountId, RuntimeConfig};
...
pub fn setup_with_config(vm_config: RuntimeConfig) {
...
pub fn setup_free() {
    crate::testing_env!(VMContextBuilder::new().build(), RuntimeConfig::free())
}
