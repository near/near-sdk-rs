...
use near_std::token::FungibleToken as FT;
...
impl FungibleToken {
    ...
    pub fn new(owner_id: AccountId, total_supply: U128) -> Self {
        ...
        Self { token: near_std::token::Token::new(owner_id, total_supply.into()) }
    }
}
...
mod tests {
    ...
    use near_std::constants::STORAGE_PRICE_PER_BYTE;
