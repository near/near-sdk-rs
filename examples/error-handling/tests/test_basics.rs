...
async fn test_error_handling(
    ...
    check_call(&contract, "inc_persist_on_err", true, 6, Some("Error { repr: Custom { kind: Execution, error: ActionError(ActionError { index: Some(0), kind: FunctionCallError(ExecutionError(\"Smart contract panicked: {\\\"error\\\":{\\\"name\\\":\\\"CUSTOM_CONTRACT_ERROR\\\",\\\"cause\\\":{\\\"name\\\":\\\"error_handling::MyErrorEnum\\\",\\\"info\\\":{\\\"tag\\\":\\\"X\\\"}}}}\")) }) } }".to_string())).await;
    check_call(&contract, "inc_just_result", true, 6, Some("Error { repr: Custom { kind: Execution, error: ActionError(ActionError { index: Some(0), kind: FunctionCallError(ExecutionError(\"Smart contract panicked: {\\\"error\\\":{\\\"name\\\":\\\"CUSTOM_CONTRACT_ERROR\\\",\\\"cause\\\":{\\\"name\\\":\\\"error_handling::MyErrorStruct\\\",\\\"info\\\":{\\\"x\\\":5}}}}\")) }) } }".to_string())).await;
    check_call(&contract, "inc_base", true, 6, Some("Error { repr: Custom { kind: Execution, error: ActionError(ActionError { index: Some(0), kind: FunctionCallError(ExecutionError(\"Smart contract panicked: {\\\"error\\\":{\\\"name\\\":\\\"CUSTOM_CONTRACT_ERROR\\\",\\\"cause\\\":{\\\"name\\\":\\\"error_handling::MyErrorStruct\\\",\\\"info\\\":{\\\"x\\\":5}}}}\")) }) } }".to_string())).await;
